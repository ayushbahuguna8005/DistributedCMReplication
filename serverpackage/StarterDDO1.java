...
public class StarterDDO1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			portDetailsOfOtherReplicas.put(2,6670);
			portDetailsOfOtherReplicas.put(3,6673);
			BullyProcess process1 = new BullyProcess(new ReliableSocket(), 1, "ddo",7500, 6667, ddoLog, portDetailsOfOtherReplicas);
